...
public class TestData {
    ...
    public final static String TEST_EMAIL_FOR_DISCOUNT_POPUP = "test_email+1@example.com";
    public final static String TEST_PHONE_NUMBER_FOR_DISCOUNT_POPUP = "6102458670";
